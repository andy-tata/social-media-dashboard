  ...
  return (
    <div className="p-4 lg:p-6 space-y-4">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">所有貼文的互動數據（預計每日抓取各粉專最新 30 篇貼文）</p>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <MetricCard
          title="本週總互動"
          value={thisWeekInteraction.toLocaleString()}
          change={interactionChange}
          subtitle={`vs 上週 · ${filterLabel}`}
        />
        <MetricCard
          title="本週平均互動率"
          value={`${thisWeekEngagement.toFixed(2)}%`}
          ...
          <TableHeader>
            <TableRow>
              ...
              <TableHead
                ...
                onClick={() => handleSort('reactions_total')}
              >
              ...
              <TableRow key={post.id}>
                ...
                <TableCell>
                  <Badge variant="outline" className="text-xs">
                    {CATEGORY_LABELS[post.post_category] || post.post_category}
                  </Badge>
                </TableCell>
